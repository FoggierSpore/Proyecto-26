...
function setup() {
	...
	//se crean los objetos de la clase bob 
	...
	//igual se cran los objetos de la clase rope
...
//cuendo se presiona la flecha hacia arriba la pelota sube contra la grabedad
function keyPressed() {
	if (keyCode === UP_ARROW) {
